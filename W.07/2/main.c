...
int main()
{
    ...
    for (int i=1; i<10;i++)
    {
        ...
        std[i].programming=std[i-1].programming-5;
        std[i].dataStructure=std[i-1].dataStructure+4;
        std[i].discreteMath=std[i-1].discreteMath+6;
        std[i].algorithms=std[i-1].algorithms+3;
    }
